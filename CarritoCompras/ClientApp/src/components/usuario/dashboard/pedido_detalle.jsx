...
import { usuarioPedidoDetallesService  } from '../../../api';
...
//#region CONSTANTES-FUNCIONES ESTE JSX
  ...
  useEffect(() => {
    ...
    usuarioPedidoDetallesService.getUsuarioPedidoDetallesByIdUsuarioPedido(props.selectedRow.id_usuario_pedido)
...
export const mapStateToProps = ( state ) => {
  return {
    pedidoDetalle: state.data.pedidoDetalle ? state.data.pedidoDetalle : []
  };
}

export default connect(mapStateToProps)( PedidoDetalle );