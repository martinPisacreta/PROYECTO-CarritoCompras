...
function Dashboard_Update_User({ history }) {
    ...
    function onSubmit(fields, { setStatus, setSubmitting }) {
        ...
        usuariosService.update(user.id, campos)
            .then(() => {
                alertService.success('Actualización exitosa , en caso de haber cambiando la contraseña , en el proximo inicio de sesion debe colocar la nueva', { keepAfterRouteChange: true });
