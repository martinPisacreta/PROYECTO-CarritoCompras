...
function ForgotPassword() {
    ...
    function onSubmit({ email }, { setSubmitting }) {
        alertService.clear();
        usuariosService.forgotPassword(email)
            .then(() => alertService.success('Por favor revise su correo electrónico para obtener instrucciones de restablecimiento de contraseña'))
