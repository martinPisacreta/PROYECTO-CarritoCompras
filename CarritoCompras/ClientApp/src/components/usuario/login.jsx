...
function InicioSesion({ history, location }) {
    ...
    function onSubmit({ email, password }, { setSubmitting }) {
        alertService.clear(); //limpio todas las alertas
    ...
    return (
        ...
        <div className="main">
            ...
            <Breadcrumb parent1={ [ "Iniciar Sesión", "usuario/login" ] } />
...
export default React.memo( InicioSesion );