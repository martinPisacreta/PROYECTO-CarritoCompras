...
import { addToCart, addToCompare, showQuickViewModal, filterSort } from '../../../actions';



function ArticuloDevExpresList( props ) {
    let { addToCart, addToCompare, showQuickViewModal,pathImgMarca} = props;
    ...
    const [utilidad,setUtilidad] = useState(user ? user.utilidad : 20); //seteo la utilidad del usuario
    ...
    const dataSource = createStore({
        key: 'id',
        loadUrl: `api/ArticulosDevExpress/GetArticulos/${utilidad}`,
    ...
    if ( 0 !== selectedRowsData.stockArticulo )
        addToCart( selectedRowsData, cantidad );
    }
        ...
        <div className='p5'>
                ...
                >
                    ...
                    <Column  
                        ...
                        caption="Marca"  
                        visible={true}  
                        filterValue={pathImgMarca  && pathImgMarca} //si la marca tiene imagen , muestro el nombre de la imagen , sino muestro el nombre de la marca
...
export default connect( mapStateToProps, { addToCart, addToCompare, showQuickViewModal, filterSort } )( ArticuloDevExpresList );