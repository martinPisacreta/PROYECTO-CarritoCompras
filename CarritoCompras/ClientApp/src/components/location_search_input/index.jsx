...
class LocationSearchInput extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      id: this.props.id //cargo en id , el id del usuario , en caso de que this.props.id sea 0 , es porque el usuario no existe todavia
    };
  }
  ...
  componentDidMount() {
    ...
    if(this.state.id > 0) //this.state.id > 0 quiere decir que estoy entrando con un usuario existente
    {
        usuariosService.getById(this.state.id)
