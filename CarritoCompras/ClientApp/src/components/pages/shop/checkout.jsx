...
function Checkout( props ) {
    ...
    return (
        <>
            <Helmet>
                <title>Encendido Alsina | Checkout</title>
            </Helmet>

            <h1 className="d-none">Encendido Alsina - Checkout</h1>

            <div className="main">

                <PageHeader  subTitle="Checkout" />
                <Breadcrumb title="Checkout" parent1={ [ "Carrito de Compras", "catalogo/list" ] } />
                                            ...
                                            <table className="table table-summary">
                                                ...
                                                <tbody>
                                                    ...
                                                    { cartlist.map( ( item, index ) =>
                                                        <tr key={ index }>
                                                            <td><Link to="#">{ item.codigoArticulo }</Link></td>
