...
// import Utils
import { mobileMenu, preventArticuloDefault, removePreventArticuloDefault, stickyHeaderHandler } from '../utils';
...
function App( props ) {
    ...
    useEffect( () => {
        ...
        // prevent articulo thumb icons
        preventArticuloDefault();

        return () => {
            window.removeEventListener( 'scroll', stickyHeaderHandler );

            // remove listeners of prevent articulo
            removePreventArticuloDefault();
        }
    }, [] )
